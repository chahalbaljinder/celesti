          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
              {contactInfo.map((item, index) => (
                ...
                >
                  <div className="mx-auto bg-gray-100 dark:bg-gray-700 w-12 h-12 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 mb-4">
                    {item.icon}
                  </div>
            ...
            >
              <div className="bg-gray-100 dark:bg-gray-800 rounded-xl overflow-hidden h-80 w-full">
