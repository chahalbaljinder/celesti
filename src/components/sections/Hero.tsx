      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-4">
          <motion.div
            ...
            className="space-y-2"
          >
            <div className="inline-block rounded-full bg-[#1E293B] px-3 py-1 text-sm text-[#D4AF37] border border-[#D4AF37]/30">
              PREMIUM DEVELOPMENT
            </div>
          </motion.div>
          <motion.h1
          ...
          >
            Web Apps that{" "}
            <span className="bg-gradient-to-r from-[#D4AF37] to-[#FEF3C7] bg-clip-text text-transparent">
              Make Sense.
            </span>
          </motion.h1>
          <motion.p
