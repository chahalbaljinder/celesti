...
const Testimonial = ({ quote, name, position, company }: TestimonialProps) => {
  return (
    ...
    >      
      <div className="mb-8">        <div className="relative h-16 w-16 overflow-hidden rounded-full border-2 border-[#FAD4D8]/50">
          <Image
      ...
      </div>      <div className="text-[#FAD4D8] text-3xl font-serif mb-4">"</div>
      ...
      <p className="text-sm text-gray-500 dark:text-[#333333] opacity-70">
        {position} at {company}
      </p>
    </motion.div>
  );
...
const Testimonials = () => {  return (
    <section className="w-full py-16 md:py-32 bg-gray-50 dark:bg-[#F2F0D5]/95 relative">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-3 dark:text-[#333333]">What Our Clients Say</h2>
          <p className="text-gray-600 dark:text-[#333333] max-w-xl mx-auto">We're proud to have helped numerous businesses reach their digital potential</p>
        </div><Testimonial
