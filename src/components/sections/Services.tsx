...
const ServiceCard = ({ 
  ...
  return (
    ...
    >
      <div className="inline-flex items-center justify-center rounded-lg bg-gray-100 p-3 mb-4 dark:bg-[#0F172A] border border-transparent dark:border-[#D4AF37]/20">
        <Image 
          src={icon} 
          alt={title}
          width={24}
      ...
      <h3 className="text-lg font-semibold mb-2 dark:text-[#D4AF37]">{title}</h3>
    ...
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-3 dark:text-[#D4AF37]">Our Premium Services</h2>
